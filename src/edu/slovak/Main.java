...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-------------------------------------------------------------------");
        LocalDateTime timestamp4 = LocalDateTime.now(); // start add elements to LinkedList
        for (int i = 0; i< 1000; i++) {
       ...
       // output result
        ...
        System.out.println("-------------------------------------------------------------------");
        LocalDateTime timestamp8 = LocalDateTime.now(); // start update elements to arrayList
        // update 1000 elemens on the beginning of ArrayList
        for (int i = 0; i< 1000; i++) {
            elementsArray.set(0, 4);
        }
        // timestamp for finish point after update elements on the beginning
        LocalDateTime timestamp9 = LocalDateTime.now();
        for (int i = 0; i< 1000; i++) {
            elementsArray.set(elementsArray.size() / 2, 5);
        }
        // timestamp for finish point after update elements on the middle
        ...
        // timestamp for finish point after update elements on the end
        ...
        LocalDateTime timestamp12 = LocalDateTime.now(); // start update elements to LinkedList
        // updating 1000 elements on the begin of LinkedList
        for (int i = 0; i< 1000; i++) {
            elementsLinked.add(0, 4);
        }
        // timestamp for finish point after update elements on the beginning
        LocalDateTime timestamp13 = LocalDateTime.now();
        // update 1000 elements on the middle of LinkedList
        for (int i = 0; i< 1000; i++) {
            elementsLinked.add(elementsLinked.size() / 2, 5);
        }
        // timestamp for finish point after update elements on the middle
        LocalDateTime timestamp14 = LocalDateTime.now();
        // update 1000 elements on the end of LinkedList
        for (int i = 0; i< 1000; i++) {
        ...
        System.out.println("The fastest point to update elements to LinkedList: beginning and end of list.");
        ...
        // delete 1000 elements on the begin of ArrayList
        for (int i = 0; i< 1000; i++) {
            elementsArray.remove(0);
        }
        // timestamp for finish point after delete elements on the beginning
        LocalDateTime timestamp17 = LocalDateTime.now();
        for (int i = 0; i< 1000; i++) {
            elementsArray.remove(elementsArray.size() / 2);
        }
        // timestamp for finish point after delete elements on the middle
        LocalDateTime timestamp18 = LocalDateTime.now();
        for (int i = 0; i< 1000; i++) {
            elementsArray.remove(elementsArray.size() - 1);
        }
        // timestamp for finish point after delete elements on the end
        ...
        System.out.println("The fastest point to delete elements to LinkedList: beginning and end of list.");
